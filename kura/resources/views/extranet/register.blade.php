<!-- Register -->
<section id="contact-form" style="background: #444 ">
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 class="section-heading text-uppercase" style="color: #fff">Inscription</h2>
                ...
                <form action="{{ route('extranet.storeUser') }}" class="form" method="post" id="moral" enctype="multipart/form-data" style="display: none">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label>Nom et Prénoms de la Personne Ressource</label><br>
                                <input class="form-control" name="name" type="text" placeholder="Votre Nom & Prénoms *" required="required" data-validation-required-message="Entrez votre adresse mail SVP enter your email address.">
                            </div>
                            <div class="form-group">
                                <label>Nom de la Structure</label><br>
                                <input class="form-control" name="resource_name" type="text" placeholder="Nom de la Structure" >
                            </div>
                            <div class="form-group">
                                <label>Numéro d'Enrégistrement de la Structure</label><br>
                                <input class="form-control" name="resource_num" type="text" placeholder="Numéro d'Enrégistrement de la Structure" >
                            </div>
                            <div class="form-group">
                                <label>Téléphone</label><br>
                                <input class="form-control" name="telephone" type="text" placeholder="Contact" >
                            </div>
