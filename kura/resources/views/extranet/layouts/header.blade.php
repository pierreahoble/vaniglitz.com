...
<header class="masthead"
        style="
        background-image: url('{{ url(env('STORAGE_PATH').'shopping.jpg') }}')!important;
...
><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <div style="background: rgb(0, 0, 0, 0.4)">
            ...
            <div class="intro-text">
                  ...
                  @endif
                <div class="intro-lead-in" style="color: #fff">Shopping à partir de <b style="font-weight: bolder; font-size: 1.3em">{{number_format($MontantMin, 0, '', '.')}} <sup> FCFA</sup></b> seulement</div>
                ...
                {{--<form action="searchcar#portfolio" method="post" class="search-intro">--}}
                    ...
                    <div class="input-bloc">
                        ...
                        <input type="number" min="{{$MontantMin}}" max="{{$MontantMax}}" value="{{$MontantMin}}" name="amount_min">
                    </div>

                    <div class="input-bloc">
                        <i style="font-style: normal; font-weight: bold"><sup style="color: #bd2130;">Montant Maximum en FCFA</sup></i>
                        <input type="number" min="{{$MontantMin}}" max="{{$MontantMax}}" value="{{$MontantMax}}" name="amount_max">
                    </div>
