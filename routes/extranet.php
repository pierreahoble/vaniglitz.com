...
Route::any('invoice/preview/{ids}/{mode}/{delivery}/{total}', 'InvoiceController@preview')->name('previewInvoice');
...
Route::any('invoice/download/{id}', 'InvoiceController@download')->name('downloadInvoice');
