...
Route::get('Produits_Désactivés', 'CarController@index2')->name('indexCar2');
...
Route::post('AjouterImage+/{id}','CarController@AjouterImage')->name('AjouterImage+');
Route::get('EnleverImage/{id}','CarController@EnleverImage')->name('EnleverImage');
...
//Invoice::Routes
Route::get('FinalPayement','InvoiceController@FinalPayement')->name('FinalPayement');
...
Route::get('Supprimerfacture/{id}','InvoiceController@Supprimerfacture')->name('Supprimerfacture');
