<!-- Connexion -->
<div id="contact-form">
    <section style="background: #444;margin-top: -10%">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading text-uppercase" style="color: #fff">Connexion</h2>
                    <h3 class="section-subheading text-muted">Connectez-vous si vous êtes déja client pour accéder aux achats, à défaut créez votre compte</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <form action="#" id="loginForm" method="post" >
                        ...
                        <div class="row">
                           <div class="col-md-12 alert alert-danger" style="display: none" id="msg">
                            ...
                            <a href="#register-form" id="show-register" style="margin-left: 18px; font-weight: bold">Créer un compte</a>
                        </div>
                    </form>
                </div>
            </div>
