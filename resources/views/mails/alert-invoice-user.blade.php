                                                ...
                                                <div class="middle">
                                                    ...
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <td><b>{{ $data['no_driver_amount'] }} <sup>FCFA</sup></b></td>
                                                        </tr>
                                                        <tr>
                                                            <td>Montant de réduction</td>
                                                            <td><b>{{ $data['reduction_amount'] }} <sup>FCFA</sup></b></td>
                                                        </tr>
                                                        <tr>
                                                            <td>Montant Véhicule HT</td>
                                                            <td><b>{{ $reservation->amount }} <sup>FCFA</sup></b></td>
                                                        </tr>
                                                        <tr>
                                                            <td>Montant total HT</td>
                                                            <td><b>{{ $reservation->amount + $data['no_driver_amount'] }} <sup>FCFA</sup></b></td>
                                                        </tr>
                                                        <tr>
                                                            <td>Montant total TTC</td>
                                                            <td><b>{{ $data['ttc'] }} <sup>FCFA</sup></b></td>
                                                        </tr>
                                                        <tr>
                                                            <td>Caution</td>
                                                            <td><b>{{ $data['bail'] }} <sup>FCFA</sup></b></td>
                                                        </tr>
                                                        <tr>
                                                            <td><br><h2>Total à payer</h2></td>
                                                            <td><br><h2>{{ $data['total'] }} <sup>FCFA</sup></h2></td>
                                                        </tr>
                                                    </table>
